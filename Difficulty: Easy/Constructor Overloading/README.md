<h2><a href="https://www.geeksforgeeks.org/problems/constructor-overloading/1?page=1&category=CPP&status=unsolved&sortBy=submissions">Constructor Overloading</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Design a class as described below.</span></p>
<blockquote>
