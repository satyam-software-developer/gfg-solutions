<h2><a href="https://www.geeksforgeeks.org/problems/compare-two-numbers/1?page=1&category=CPP&status=unsolved&sortBy=submissions">Compare two numbers</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">You are given two numbers <strong>a&nbsp;</strong>and&nbsp;<strong>b</strong>. If&nbsp;a&nbsp;is greater than b&nbsp;print <strong>1</strong>, otherwise print <strong>0</strong>.</span></p>
